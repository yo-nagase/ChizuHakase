...
- **★15(金)の札を持ち、かつ れんぞくが 15 以上** — 両方そろった時点で
  その県の金札が虹になる。金が先でも、れんぞく 15 が先でもよい
- **一度虹になったら戻らない。** れんぞくが切れてもカウンタが黙って 0 に戻る
  だけで、「きれた」とは言わない・見せない(§12)。星も段位も動かない
...
- 虹になった回は**結果画面の先頭で「🌈 にじいろに なった カード!」として祝う**。
  ...
  文字だけの札では何も渡していない
- **この祝いは獲得カード欄では代用できない。** れんぞく 15 に届いた時点で
  その県の金札が**まとめて**虹になり、そのステージで引いていない札も混ざる。
